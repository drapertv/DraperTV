...
class SpeakersControllerTest < ActionController::TestCase
  ...
  test "should create speaker" do
    assert_difference('Speaker.count') do
      post :create, speaker: { bio: @speaker.bio, email: @speaker.email, name: @speaker.name, profilepic: @speaker.profilepic }
    end
  ...
  test "should update speaker" do
    patch :update, id: @speaker, speaker: { bio: @speaker.bio, email: @speaker.email, name: @speaker.name, profilepic: @speaker.profilepic }
    assert_redirected_to speaker_path(assigns(:speaker))
  end
