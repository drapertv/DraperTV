class EmailsController < ApplicationController
  ...
  def create
    ...
    p email_params
    contact = HTTParty.post("https://api2.autopilothq.com/v1/contact", body: {"contact" => {"FirstName" => email_params[:full_name], "Email" => email_params[:body]}}.to_json, headers: {"autopilotapikey" => ENV["AUTOPILOT_KEY"]})
