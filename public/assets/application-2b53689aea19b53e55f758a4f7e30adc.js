...
var VideosBox = React.createClass({displayName: "VideosBox",
...
var VideoList = React.createClass({displayName: "VideoList",
  render: function() {
    var VideoNodes = this.props.data.map(function (video) {
      return (
        React.createElement(Video, {title: video.title, id: video.id, length: video.length})
      );
    });
    return (
      React.createElement("div", {className: "regular-videos"}, VideoNodes)
    );
  }
});
...
var Video = React.createClass({displayName: "Video",
  render: function() {
    return (
      React.createElement("li", {className: "video-item-container"}, 
        React.createElement("div", {className: "video-img"}, 
             React.createElement("a", {href: "videos/" + this.props.id}, 
                React.createElement("img", {alt: "Play icon", className: "video-play", src: "/assets/play-icon.png"}), 
                React.createElement("span", {className: "section-time"}, " ", this.props.length, " "), 
                React.createElement("img", {alt: "Elon vid", className: "video-thumbnail", src: "/assets/elon-vid.png"})
            )
        ), 
        React.createElement("div", {className: "video-info"}, 
          React.createElement("a", {href: "videos/" + this.props.id}, 
            React.createElement("p", {className: "text-ellipsis qwatch-title"}, " ", this.props.title)
          )
        )
      )
    );
...
(function() {
  ...
  Header = {
    ...
    toggleSearchOnClick: function() {
      return $('.menu, .logo, .search-box, header > a').toggle();
    },
...
(function() {
  ...
  Home = {
    init: function() {
      $('body').on('click', '.content-expand-header', this.expandContentOnClick);
      $('body').on('click', '.featured-tabs button', this.showTabOnClick);
      this.mobile = $(window).width() < 1024;
      $('.home').parents('body').addClass('show-scroll-bar');
      $('body').on('click', '.close-banner', this.closeBanner);
      if (this.mobile) {
        Home.onMobile = true;
      } else {
        Home.onDesk = true;
      ...
      setInterval(function() {
        if ($(window).width() < 1024 && Home.onDesk) {
          ...
          return Home.onMobile = true;
        }
      }, 500);
      setInterval(function() {
        if ($(window).width() > 1023 && Home.onMobile && !Home.slideShowStarted) {
          Home.initSlideShowOnPageLoad();
          return Home.onDesk = true;
        }
      }, 500);
      if (this.mobile) {
        this.initCarouselOnPageLoad();
      }
      if (!this.mobile) {
        return this.initSlideShowOnPageLoad();
      }
    },
    closeBanner: function(e) {
      e.preventDefault();
      $(this).parent('.livestream-banner').addClass('animated flipOutX').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function() {
        return $(this).hide();
      });
      return $.get('/hidebanner');
    },
    showTabOnClick: function() {
      if ($('.video-player').length < 1 || Home.mobile) {
        ...
        return $("." + ($(this).attr('data-show'))).toggleClass('hide-section');
      }
    },
    expandContentOnClick: function() {
      $(this).parents('.content').find('.content-expand-content').toggle();
      return $(this).children('.arrow').toggleClass('rotate180');
    },
    initCarouselOnPageLoad: function() {
      return $('.featured-carousel.no-desk').slick({
        arrow: false,
        autoplay: true,
        autoplaySpeed: 3000,
        speed: 1000,
    ...
    initSlideShowOnPageLoad: function() {
      ...
      setInterval(function() {
        ...
        return toFadeIn.fadeIn(1000);
      }, 5000);
      $('.featured-carousel-side .featured-item:lt(2)').show();
      return setInterval(function() {
        var toHide, toShow, toSlideDown;
...
(function() {
  ...
  Playlist = {
    init: function() {
      $('body').on('click', '.section-title-menu', this.toggleCategoriesOnClick);
      setInterval(this.changeScrollPercentOnScroll, 25);
      this.pageHeight = $('body').height();
      $('body').on('click', '.scroll-grey, .scroll-green', this.scrollPageOnClick);
      $('body').on('mousemove', '.scroll-grey, .scroll-green', this.moveScrollPercentOnMouseMove);
      $('body').on('mouseleave', '.scroll-grey, .scroll-green', this.continueChangeOnMouseLeave);
      return Playlist.scrollBarIsPaused = false;
    },
    continueChangeOnMouseLeave: function() {
      return Playlist.scrollBarIsPaused = false;
    },
    scrollPageOnClick: function(e) {
      var percentOfPageToScroll, pixelsToScroll;
    ...
    moveScrollPercentOnMouseMove: function(e) {
      var percent;
      percent = e.clientY - 110;
      Playlist.scrollBarIsPaused = true;
      $('.scroll-percent').text(percent + "%");
      return $('.scroll-percent').css("bottom", (100 - percent - 5) + "px");
    },
    changeScrollPercentOnScroll: function() {
      var barHeight, currentHeight;
      if (!Playlist.scrollBarIsPaused) {
        ...
        if (barHeight > 100 || (barHeight > 97 && barHeight < 100)) {
          barHeight = 100;
        }
        $('.scroll-percent').text(barHeight + "%");
        return $('.scroll-percent').css("bottom", (100 - barHeight - 5) + "px");
      }
    },
    toggleCategoriesOnClick: function() {
      return $('.categories').toggle();
    }
  };
