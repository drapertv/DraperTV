...
(function() {
  ...
  Header = {
    init: function() {
      ...
      if (!this.mobile) {
        $(document).scroll(this.freezeHeader);
      }
...
(function() {
  ...
  Home = {
    init: function() {
      ...
      $('body').on('click', '.close-livestream', this.closeBanner);
      $('body').on('click', '.close-email-banner', this.closeEmailBanner);
      $('body').on('click', '.close-application-link', this.closeApplicationNotification);
      $('body').on('ajax:success', '#new_email', this.thankUserForEmail);
      if (this.mobile) {
        Home.onMobile = true;
      } else {
        Home.onDesk = true;
    ...
    thankUserForEmail: function(event, data) {
      $('.optin-text').text('Thank You!');
      $('#new_email')[0].reset();
      return setTimeout(function() {
        return Home.closeEmailBanner();
      }, 500);
    },
    closeEmailBanner: function(e) {
      return $('#banner').addClass('animated flipOutX').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function() {
        return $(this).hide();
      });
    },
    closeApplicationNotification: function(e) {
      e.preventDefault();
      ...
      return $.get('/hidebanner?hide_type=application-link');
    },
    closeBanner: function(e) {
      ...
      return $.get('/hidebanner?hide_type=livestream');
    },
