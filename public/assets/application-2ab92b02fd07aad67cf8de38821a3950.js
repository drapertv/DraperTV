...
(function() {
  ...
  Comments = {
    init: function() {
      ...
      $('body').on('keydown', '#new_comment textarea', this.submitComment);
      return $('body').on('click', '.comment-reply', this.showReplyForm);
    },
...
(function() {
  ...
  Management = {
    init: function() {
      return $('body').on('submit', '#beta-invite-form', this.popuplateUserEmailsInput);
    },
