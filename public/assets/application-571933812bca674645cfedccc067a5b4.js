...
(function() {
  ...
  Home = {
    init: function() {
      ...
      $('body').on('submit', '#new_email', this.thankUserForEmail);
      this.bounceNotifications();
      if (this.mobile) {
        Home.onMobile = true;
      } else {
        Home.onDesk = true;
    ...
    bounceNotifications: function() {
      ...
      setTimeout(function() {
        ...
        if ($('.notification').length > 0) {
          return bounce.applyTo($('.notification'));
        }
      }, 500);
      return setTimeout(function() {
        return $('.close-banner').fadeIn();
      }, 750);
    },
    ...
    closeApplicationNotification: function(e) {
      e.preventDefault();
      $(this).parent('.livestream-banner').fadeOut();
  ...
  Playlist = {
    ...
    linkifyLinks: function() {
      $('.linkify, .linkify p, .linkify div').each(function() {
        var linkifiedText;
        linkifiedText = Playlist.linkify($(this).html());
