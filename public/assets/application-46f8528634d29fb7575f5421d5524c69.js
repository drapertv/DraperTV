...
(function() {
  ...
  Challenges = {
    init: function() {
      return $('body').on('submit', '.challenge-comment-form .new_comment', this.validateChallengeComment);
    },
...
(function() {
  ...
  Visitors = {
    init: function() {
      ...
      $('body').on('click', this.hideLoginModal);
      ...
      $('body').on('click', '.welcome-close', this.closeWelcome);
      $('body').on('click', '.mobile-menu-icon', this.openMobileMenu);
      return $('.content-container, .playlist-container').on('click', this.closeMobileMenu);
    },
    closeMobileMenu: function(e) {
      console.log(e.target);
      return $('.mobile-menu').hide();
    },
    openMobileMenu: function() {
      return $('.mobile-menu').show();
    },
